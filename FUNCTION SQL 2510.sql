...
CREATE OR REPLACE FUNCTION MEDIA1(N1 INTEGER, N2 INTEGER) RETURNS NUMERIC(10,2) AS
'
	SELECT (N1+N2)/2.0;
'LANGUAGE SQL;
...
SELECT COD, NOME, DOBRA_SALARIO(INSTRUTOR.*) AS DOBRO FROM INSTRUTOR WHERE NOME='JESSE FERA';
